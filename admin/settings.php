            ...
            <div class="card custom-card-2 mt-2">
                <div class="card-body p-4">
                    <form method="post" action="functions/functions.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn  float-end" name="update_settings" style="background-color: #7d1128;">UPDATE</button>
                        </div>
                    </form>
                </div>
            </div>
            <button type="button" class="btn mt-3" name="change_password" data-bs-toggle="modal" data-bs-target="#myModal">CHANGE PASSWORD</button>
        </div>
    </div>
